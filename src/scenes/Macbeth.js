class Macbeth extends Phaser.Scene {
    ...
    create() {
        ...
        this.first_witch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'first_witch').setOrigin(0, 1).setScale(0.5);
        this.second_witch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'second_witch').setOrigin(0, 1).setScale(0.5);
        this.neptune = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'neptune').setOrigin(0, 1);
        this.third_witch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'third_witch').setOrigin(0, 1).setScale(0.5);
